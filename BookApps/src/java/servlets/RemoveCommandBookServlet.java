...
/**
 *  Servlet permattant de supprimer un livre du panier.
 * @author Thibaud VERBARE & David JOSIAS
 */
@WebServlet(name = "RemoveCommandBook", urlPatterns = {"/RemoveCommandBook"})
public class RemoveCommandBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // On récupère le livre a supprimer :
            String title = request.getParameter("title");
            List<Book> book = bookServ.searchBook(title);
            
            // On retire le livre
            cart.removeBookToCart(book.get(0));
